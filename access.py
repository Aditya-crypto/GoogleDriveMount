...
mimeTypes = [ "application/vnd.google-apps.audio", "application/vnd.google-apps.document", "application/vnd.google-apps.spreadsheet", "application/vnd.google-apps.presentation", "application/vnd.google-apps.drawing"]
...
def copy(from_path, to_path, directory):
    ...
    upload_drive(from_path, file_name, folder_id,to_path)
